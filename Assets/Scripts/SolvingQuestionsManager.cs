    ...
    void SetResult()
    {
        ...
        switch (Questions[questionNum][0]) //  Questions[questionNum][0]
        {
            ...
            case "SA":
                ...
                testTXT.text = "Á¤´äÀº:'" + correctAnswer + "'(" + correctAnswer.Count() + ")'\nÀÔ·ÂµÈ ¹®ÀÚ´Â:" + answer + "'(" + answer.Count() + ")'\n´Ü¼ø ºñ±³:"+ (correctAnswer== answer)+"\nº¸Á¤ ºñ±³:"+ IsAnswerCorrect(correctAnswer, answer);
